...
import sys, os
sys.path.insert(0, os.path.expanduser("~/j13-ops/zangetsu"))
...
def test_05_arena2_hysteresis():
    ...
    with open(os.path.expanduser("~/j13-ops/zangetsu/arena/arena2_threshold.py")) as f:
        code = f.read()
...
def test_06_arena5_composite_score():
    ...
    with open(os.path.expanduser("~/j13-ops/zangetsu/arena/arena5_elo.py")) as f:
        code = f.read()
...
def test_08_arena13_consistent_fitness():
    ...
    with open(os.path.expanduser("~/j13-ops/zangetsu/arena/arena13_evolve.py")) as f:
        code = f.read()
    assert "0.6" in code and "0.4" in code
...
def test_13_db_tables():
    ...
    conn = psycopg2.connect(host="127.0.0.1", port=5432, user="zangetsu",
                            password=os.getenv("ZV5_DB_PASSWORD", ""), dbname="zangetsu")
    cur = conn.cursor()
...
def test_14_parquet_data():
    ...
    data_dir = os.path.expanduser("~/j13-ops/zangetsu/data/ohlcv")
...
def test_15_config_loads():
    ...
    with open(os.path.expanduser("~/j13-ops/zangetsu/config/settings.py")) as f:
        code = f.read()
...
def test_16_all_arena_files():
    ...
    arena_dir = os.path.expanduser("~/j13-ops/zangetsu/arena")
...
def test_17_engine_components():
    ...
    comp_dir = os.path.expanduser("~/j13-ops/zangetsu/engine/components")
