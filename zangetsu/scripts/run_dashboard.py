...
DB_DSN = f"dbname=zangetsu user=zangetsu password={os.getenv('ZV5_DB_PASSWORD', '')} host=127.0.0.1 port=5432"
...
STATIC_DIR = os.path.expanduser("~/j13-ops/zangetsu/dashboard/static")
