...
Usage:
    python -m zangetsu_v5.services.data_collector          # all symbols
    python -m zangetsu_v5.services.data_collector BTCUSDT  # single symbol
"""
...
DATA_DIR = Path("/home/j13/j13-ops/zangetsu_v5/data")
