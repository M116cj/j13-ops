...
DB_PASSWORD: str = os.getenv("ZV5_DB_PASSWORD", "9c424966bebb05a42966186bb22d7480")
...
PARQUET_DIR: str = os.getenv(
    "ZV5_PARQUET_DIR", "/home/j13/j13-ops/zangetsu_v5/data/ohlcv"
...
INDICATOR_LIBRARY_PATH: str = os.getenv(
    "ZV5_INDICATOR_LIB",
    "/home/j13/j13-ops/zangetsu_v5/indicator_engine/target/release/libzangetsu_indicators.so",
)                                           # CONSOLE_HOOK: indicator_library_path

# ── Logging ──────────────────────────────────────────────────────
LOG_LEVEL: str = os.getenv("ZV5_LOG_LEVEL", "INFO")
LOG_FILE: str = os.getenv("ZV5_LOG_FILE", "/home/j13/j13-ops/zangetsu_v5/logs/engine.jsonl")
